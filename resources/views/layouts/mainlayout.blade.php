...
<body>
    <div class="main d-flex flex-column justify-content-between"> <!-- Removed the 'class' word -->
        ...
        <div class="body-content h-100">
                <div class="row g-0 h-100"> <!-- Removed the extra equal sign '=' -->
                    <div class="sidebar col-lg-2 collapse d-lg-block" id="navbarTogglerDemo03"> <!-- Removed the extra equal sign '=' -->
